...
//Actividad 4 4CV1 Programa 1 Sistema V
#include <sys/types.h>
#include <sys/ipc.h>
#include <sys/shm.h>
#include <stdlib.h>
...
{   // Declaracion de variables
    ...
    printf("\n [I] Iniciando proceso de turnos con turno inicial: %c",(*turno)); // Muestra el turno
    while(TRUE){
        while((*turno) != '0')esperando_turno(pid); // Espera a su turno
    ...
    shmdt(addr);
    /*Eliminar la region de memoria compartida*/
